...
func TestJumpHelperLocal(t *testing.T) {
	...
	log.Println("Testing Jumphelper Locally i2p-projekt.i2p", x, "forum.i2p", y)
	printKvs(x)
}
...
func TestJumpHelperLocalBool(t *testing.T) {
	...
	log.Println("Testing Jumphelper check-only Locally i2p-projekt.i2p", x, "forum.i2p", y)
}
...
func TestJumpHelperLocalA(t *testing.T) {
	...
	log.Println("Testing Jumphelper Locally http://i2p-projekt.i2p", x, "http://forum.i2p", y)
}
...
func TestJumpHelperLocalBoolA(t *testing.T) {
	...
	log.Println("Testing Jumphelper check-only Locally http://i2p-projekt.i2p", x, "http://forum.i2p", y)
}
